...
- `GET /api/graph?limit=30`: normalized categories plus deterministic knowledge, concept, and co-occurrence graph.
...
- `POST /api/collect/file`: extract an uploaded UTF-8 TXT/Markdown file up to 10 MiB without storage.
